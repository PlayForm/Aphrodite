"""
aphrodite v1.11.0 - Auto-install + launch aphrodite proxies.
...
BIN_VERSION = "v0.5.2"          # binary download version (must match Cargo.toml)
PLUGIN_VERSION = "1.11.0"        # plugin version
