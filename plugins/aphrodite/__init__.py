"""
aphrodite v1.10.0 - Auto-install + launch aphrodite proxies.
...
BIN_VERSION = "v0.5.1"          # binary download version (must match Cargo.toml)
PLUGIN_VERSION = "1.10.0"        # plugin version
