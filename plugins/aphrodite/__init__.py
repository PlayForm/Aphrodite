"""
aphrodite v1.62.14 — CCR compression plugin for Hermes Agent.
...
def register(ctx):
    ...
    ctx.register_tool(name="aphrodite_prefetch_status", schema=PREFETCH_STATUS_SCHEMA,
    LIVE_CONTAINER_SCHEMA, handler=_prefetch_status_handler,
    _live_container_handler, toolset="aphrodite")
