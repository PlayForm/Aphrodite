...
fn main() {
    ...
    eprintln!(
        "\n[bench_02] threshold boundary sweep  {} cases",
        all_cases.len()
    );
    eprintln!(
        "{:<26} {:>8} {:>8} {:>10} {:>10} {:>8}",
