...
# Actions discovered in /Volumes/CORSAIR/Developer/macOS/Application/PlayForm/Aphrodite at absorb time (informational).
DiscoveredActions=("actions/checkout" "ad-m/github-push-action" "softprops/action-gh-release" "dtolnay/rust-toolchain" "actions/cache" "actions/upload-artifact" "astral-sh/setup-uv" "astral-sh/ruff-action" "EmbarkStudios/cargo-deny-action" "dependabot/fetch-metadata" "pozil/auto-assign-issue")
