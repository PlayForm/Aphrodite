...
# Actions discovered in /Volumes/CORSAIR/Developer/macOS/Application/PlayForm/Aphrodite-Release at absorb time (informational).
DiscoveredActions=( "actions/checkout" "ad-m/github-push-action" "softprops/action-gh-release" "dtolnay/rust-toolchain" "actions/cache" "actions/upload-artifact" "astral-sh/ruff-action" "EmbarkStudios/cargo-deny-action" "dependabot/fetch-metadata" "pozil/auto-assign-issue" )
