...
Hermes Agent
  ...
  ├─ context engine: compressor (threshold: off)
  │
...
| Setting | Value |
|---|---|
| Profile | `aphrodite-barebone` |
| Provider | `deepseek (direct)` |
| Context Engine | `compressor` |
| Engine Threshold | `off` |
| Proxy Port | `:N/A` |
...
1. **Proxy health**
   ```bash
   curl -s http://127.0.0.1:N/A/health
   ```
...
# Run profile
hermes --profile aphrodite-barebone
