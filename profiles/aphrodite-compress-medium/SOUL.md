...
```
Hermes Agent
  ├─ provider: aphrodite-cache → :9797
  ├─ context engine: aphrodite (threshold: 50%)
  │
...
| Setting | Value |
|---|---|
| Profile | `aphrodite-compress-medium` |
| Provider | `aphrodite-cache → :9797` |
| Context Engine | `aphrodite` |
| Engine Threshold | `50%` |
| Proxy Port | `:9797` |
...
# Run profile
hermes --profile aphrodite-compress-medium
