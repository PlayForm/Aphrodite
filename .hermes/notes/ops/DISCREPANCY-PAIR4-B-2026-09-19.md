...
- [2026-09-19] docs/api/retrieve.md, docs/metrics/prometheus.md, docs/metrics/queries.md: links pointed at `tree/Development`; default branch is `Current` (all rewritten links use tree/Current).
