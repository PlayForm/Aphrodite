...
| `README.md`                                                                                                                                        | both               | clean                            | `tree/Development`/`blob/Current` doc URLs = sanctioned convention (Current is the distributed docs line).<br>Badge drift v2.1.4 (D) vs v2.1.3 (C) = version-track note, not identity.                                                                                                                                                                                                                                            |
