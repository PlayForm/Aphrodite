...
description: "Use when you need historical v0.8.5→v0.8.6 cycle context. Patterns canonicalized in aphrodite-operations and aphrodite-development-lessons; archival snapshot only."
version: 1.2.0
...
> `.hermes/notes/ops/ARCHIVE-2026-09-18/`. Do NOT extend this skill.
