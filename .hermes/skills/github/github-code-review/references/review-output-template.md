...
Use this as the structure for PR review summary comments. Copy and fill in
the sections. For Aphrodite PRs, reference paths by their monorepo location
(`crates/aphrodite/...`, `crates/aphrodite-hermes/...`, `plugins/aphrodite/...`)
and check crate changes against `cargo test` / `cargo clippy` at the workspace
root before approving.
