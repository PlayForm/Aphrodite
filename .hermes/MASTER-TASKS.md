...
| 47 | 🟡 | `__init__.py` | Debug banner always-on | ✅ v0.5.65 |
...
| 51 | 🟠 | 16-char vs 64-char hash mix | ✅ v0.5.65 | |
| 52 | 🟡 | `_git_summary()` race + 3s block | ❌ | |
| 53 | 🟡 | `.test-results.json` to plugin dir | ❌ | |
| 54 | 🟡 | O(n) `_inline_store` scan | ✅ v0.5.65 | |
