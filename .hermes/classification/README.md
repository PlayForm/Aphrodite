...
| [DEV-engine-build.md](DEV-engine-build.md)                     | Engine + build processes: `crates/**`, root build/config, `vendor/`                                                              | 76               |
| [DEV-knowledge-tests-bench.md](DEV-knowledge-tests-bench.md)   | Dev-side knowledge/test/bench processes: `.hermes/`, `bench/`, `tests/`, `docs/`, `assets/`                                      | 510              |
| [CUR-plugin-loader.md](CUR-plugin-loader.md)                   | Plugin/loader processes: `plugins/aphrodite/**` submodule                                                                        | 16               |
| [CUR-release-infra-identity.md](CUR-release-infra-identity.md) | Release infra + identity processes: `Maintain/`, workflows, hooks, `.gitmodules`, vendor gitlinks                                | 73               |

**Total: 675 files classified.**
