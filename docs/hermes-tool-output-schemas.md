...
[CCR: Content Types](https://github.com/PlayForm/Aphrodite/tree/Development/docs/ccr/content-types.md) for the classification taxonomy
...
> in [Enriched Preview Catalog](https://github.com/PlayForm/Aphrodite/tree/Development/docs/proxy/compression.md#enriched-preview-catalog),
