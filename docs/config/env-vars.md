...
| `APHRODITE_HOME`                                | overrides the runtime home         | `$HERMES_HOME/aphrodite` (else `~/.hermes/aphrodite`) | User-data home override: binaries, directives, `aphrodite.toml`, `ccr.db`, logs                                                                                                                                           |
