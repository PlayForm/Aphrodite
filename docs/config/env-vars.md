...
Source of truth: `crates/aphrodite/src/config.rs` (CLI args with env fallbacks), `crates/aphrodite/src/main.rs`, `plugins/aphrodite/_core/config.py` (config loaders + defaults), `plugins/aphrodite/aphrodite.toml` (TOML-driven defaults)
