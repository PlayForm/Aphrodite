...
Origin: Aphrodite exposes HTTP endpoints for proxying LLM API requests, managing CCR entries, executing tool relay calls, and health checks.

Source of truth: `crates/aphrodite/src/proxy.rs` (lines 563, 1497, 1635, 1751, 1771, 1796), `crates/aphrodite/src/retrieve.rs` (line 33)
...
Executes aphrodite tools (retrieve, compress, list) with optional async callback.
