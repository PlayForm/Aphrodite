...
→ **[Complete fork divergence analysis](https://github.com/PlayForm/Aphrodite/tree/Development/docs/HEADROOM-FORK-DIFF.md)** - every commit, every deleted file, every modified subsystem between upstream Headroom and our PlayForm fork.
