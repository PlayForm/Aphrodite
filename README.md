...
[![release](https://img.shields.io/badge/release-v0.9.8-blue)](https://github.com/PlayForm/Aphrodite/releases)
[![plugin](https://img.shields.io/badge/plugin-v1.62.66-purple)](plugins/aphrodite/plugin.yaml)
...
restarts. 14 hooks + 12 tools delegate to Rust via C ABI — 1,106 tests
(990 Rust + 116 Python). Hot-reload: rebuild the dylib and the next hook call
...
| Git log          | raw commit list                   | `[commit:e3bfa3d release(v0.9.1)]`                                     |
